...
const Navbar = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row md:justify-between justify-center items-center shadow-lg sticky top-0 bg-black z-10 py-4 px-6">
      <div className="logo mr-auto md:mx-5">
        <Link href="/">
          {/* <Image width={100} height={40} src="/balckcompanylogoi.png"  alt="Logo" /> */}
          <span className="  font-serif font-extrabold text-lg text-white">RK GROUP OF IT SOLUTION</span>
        </Link>
      </div>
      <div className="nav">
        ...
        <li className={`relative group ${router.pathname === '/Home' ? 'text-red-800' : 'text-gray-800'}`}>
            <Link href="/" className="hover:text-red-800 font-bold transition-colors duration-300 text-white">
              Home
              </Link>
          ...
          <li className={`relative group ${router.pathname === '/Services' ? 'text-red-800' : 'text-gray-800'}`}>
            <Link href="/Services" className="hover:text-red-800 font-bold transition-colors duration-300  text-white">
              Services
            </Link>
          ...
          <li className={`relative group ${router.pathname === '/Internship' ? 'text-red-800' : 'text-gray-800'}`}>
            <Link href="/Internship" className="hover:text-red-800 font-bold transition-colors duration-300  text-white">
              Internship
            </Link>
          ...
          <li className={`relative group ${router.pathname === '/Portfolio' ? 'text-red-800' : 'text-gray-800'}`}>
            <Link href="/Portfolio" className="hover:text-red-800 font-bold transition-colors duration-300  text-white">
              Portfolio
            </Link>
          ...
          <li className={`relative group ${router.pathname === '/Career' ? 'text-red-800' : 'text-gray-800'}`}>
            <Link href="/Career" className="hover:text-red-800 font-bold transition-colors duration-300  text-white">
              Career
            </Link>
          ...
          <li className={`relative group ${router.pathname === '/About' ? 'text-red-800' : 'text-gray-800'}`}>
            <Link href="/About" className="hover:text-red-800 font-bold transition-colors duration-300  text-white">
              About
            </Link>
          ...
          <li className={`relative group ${router.pathname === '/Blogs' ? 'text-red-800' : 'text-gray-800'}`}>
            <Link href="/Blogs" className="hover:text-red-800 font-bold transition-colors duration-300  text-white">
              Blogs
            </Link>
