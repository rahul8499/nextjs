...
setService(true)
  ...
  const onChangePin = (e) =>{    // localStorage.setItem("cart" , myCart);
  ...
  <div className="container px-5 py-16 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-24 object-cover " src="https://m.media-amazon.com/images/I/61Mw4M+mHwL._SX569._SX._UX._SY._UY_.jpg"/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest">onlineStore.com</h2>
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">The Catcher in the Rye</h1>
        <div className="flex mb-4">
          <span className="flex items-center">
            <svg fill="currentColor"  className="w-4 h-4 text-pink-500" viewBox="0 0 24 24">
        ...
        <p  >Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus beatae doloremque voluptatibus. Inventore dicta fugiat deleniti modi illo cumque non beatae quis provident? Incidunt aspernatur repellendus aliquam suscipit error voluptatibus..</p>
        <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
          <div className="flex">
            <span className="mr-3">Color</span>
            <button className="border-2 border-gray-300 rounded-full w-6 h-6 "></button>
            <button className="border-2 border-gray-300 ml-1 bg-gray-700 rounded-full w-6 h-6 "></button>
            <button className="border-2 border-gray-300 ml-1 bg-pink-500 rounded-full w-6 h-6 "></button>
          </div>
        ...
        <div className='pin mt-6 space-x-2 flex'>
          <input onChange={onChangePin} placeholder = "Enter Your Pin code Check Serviceavailability" className='px-2 border-2 border-pink-100 rounded-md' type="text" />
          <button onClick={checkServiceavailability} className=' text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded'>Pin</button>
